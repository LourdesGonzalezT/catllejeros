        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item navLink">
                    <a class="nav-link active" aria-current="page" href="index.php#cats-section">ADOPTA</a>
                </li>
                <li class="nav-item navLink">
                    <a class="nav-link" href="index.php#events-section">EVENTOS</a>
                </li>
                <li class="nav-item navLink">
                    <a class="nav-link" href="index.php#reports-section">NOTICIAS</a>
                </li>
                <li class="nav-item navLink">
                    <a class="nav-link" href="index.php#services-section">SERVICIOS</a>
                </li>
                <li class="nav-item navLink">
                    <a class="nav-link" href="index.php#contact-section">CONTACTO</a>
                </li>
